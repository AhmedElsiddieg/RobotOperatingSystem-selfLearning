...
class NavTest():
    def __init__(self):
        ...
        locations['ahmed_corner'] = Pose(Point(-2.462, 2.202, 0.000), Quaternion(0.000, 0.000, -0.010, 1.000))
        locations['husa_corner'] = Pose(Point(0.000, 0.000, -0.010), Quaternion(0.000, 0.000, 0.964, 0.267))
        locations['al7aaag'] = Pose(Point(0.484, -1.419, 0.000), Quaternion(0.000, 0.000, 0.644, 0.765))
